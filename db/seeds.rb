...
Message.create!(author_id: 1, body: "This is the beginning of the #general channel.", chatable_id: 2, chatable_type: "TextChannel")
Message.create!(author_id: 1, body: "This is the beginning of the #general channel.", chatable_id: 3, chatable_type: "TextChannel")
Message.create!(author_id: 1, body: "This is the beginning of the #general channel.", chatable_id: 4, chatable_type: "TextChannel")

Message.create!(author_id: 1, body: "This is the beginning of the #replayshare channel.", chatable_id: 5, chatable_type: "TextChannel")
Message.create!(author_id: 1, body: "This is the beginning of the #discussions channel.", chatable_id: 6, chatable_type: "TextChannel")
Message.create!(author_id: 1, body: "This is the beginning of the #lfscrims channel.", chatable_id: 7, chatable_type: "TextChannel")
Message.create!(author_id: 1, body: "This is the beginning of the #chill channel.", chatable_id: 8, chatable_type: "TextChannel")

Message.create!(author_id: 1, body: "This is the beginning of the #bns channel.", chatable_id: 9, chatable_type: "TextChannel")
Message.create!(author_id: 1, body: "This is the beginning of the #master-x-master channel.", chatable_id: 10, chatable_type: "TextChannel")

Message.create!(author_id: 1, body: "This is the beginning of the #announcements channel.", chatable_id: 11, chatable_type: "TextChannel")
Message.create!(author_id: 1, body: "This is the beginning of the #pick-up channel.", chatable_id: 12, chatable_type: "TextChannel")
Message.create!(author_id: 1, body: "This is the beginning of the #scrims channel.", chatable_id: 13, chatable_type: "TextChannel")

Message.create!(author_id: 1, body: "This is the beginning of the #chingus channel.", chatable_id: 14, chatable_type: "TextChannel")
Message.create!(author_id: 1, body: "This is the beginning of the #bamf channel.", chatable_id: 15, chatable_type: "TextChannel")
Message.create!(author_id: 1, body: "This is the beginning of the #overwatch channel.", chatable_id: 16, chatable_type: "TextChannel")
Message.create!(author_id: 1, body: "This is the beginning of the #smash channel.", chatable_id: 17, chatable_type: "TextChannel")
Message.create!(author_id: 1, body: "This is the beginning of the #brybotland channel.", chatable_id: 18, chatable_type: "TextChannel")
Message.create!(author_id: 1, body: "This is the beginning of the #music channel.", chatable_id: 19, chatable_type: "TextChannel")
