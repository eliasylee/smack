class User < ApplicationRecord
  ...
  def self.create_guest_account!
    ...
    dm_1 = DirectMessage.create!(speaker_id: user.id, listener_id: 4)
    Message.create!(author_id: 1, body: "This is the beginning of the direct message history between Bryan792 and ShyGuy.", chatable_type: "DirectMessage", chatable_id: dm_1.id)
    Message.create!(author_id: 4, body: "I think, going forward, we should just have the people who are playing hots most often be regulars on the team and have everyone else be subs", chatable_type: "DirectMessage", chatable_id: dm_1.id)
    Message.create!(author_id: user.id, body: "Kk then we need to decide if that is David or Blee", chatable_type: "DirectMessage", chatable_id: dm_1.id)
    Message.create!(author_id: 4, body: "they can alternate", chatable_type: "DirectMessage", chatable_id: dm_1.id)
    Message.create!(author_id: user.id, body: "Cause they are both super mia", chatable_type: "DirectMessage", chatable_id: dm_1.id)
    Message.create!(author_id: user.id, body: "Ah okay", chatable_type: "DirectMessage", chatable_id: dm_1.id)
    Message.create!(author_id: user.id, body: "btw did you say that you feel like kelvin shouldn't be solo tank?", chatable_type: "DirectMessage", chatable_id: dm_1.id)
    Message.create!(author_id: user.id, body: "in the google sheet I have me as solo tank and kelvin as flex", chatable_type: "DirectMessage", chatable_id: dm_1.id)
    Message.create!(author_id: user.id, body: "but now that I think about it, I feel like it'd be better if I was flex because of how deep my hero pool is", chatable_type: "DirectMessage", chatable_id: dm_1.id)
    Message.create!(author_id: 4, body: "id rather have you as solo tank or as a tank/bruiser in a 2 warrior comp", chatable_type: "DirectMessage", chatable_id: dm_1.id)
    Message.create!(author_id: user.id, body: "hm okay", chatable_type: "DirectMessage", chatable_id: dm_1.id)
    Message.create!(author_id: user.id, body: "we'll make it work somehow", chatable_type: "DirectMessage", chatable_id: dm_1.id)
    Message.create!(author_id: 4, body: "my only concern is if zag is still in the pool", chatable_type: "DirectMessage", chatable_id: dm_1.id)
    Message.create!(author_id: user.id, body: "?", chatable_type: "DirectMessage", chatable_id: dm_1.id)
    Message.create!(author_id: 4, body: "zag too good", chatable_type: "DirectMessage", chatable_id: dm_1.id)
    Message.create!(author_id: user.id, body: "ah yeah very possible that they'll take it during their first pick phase", chatable_type: "DirectMessage", chatable_id: dm_1.id)
    Message.create!(author_id: user.id, body: "do we want to ban first-ban rehgar btw?", chatable_type: "DirectMessage", chatable_id: dm_1.id)
    Message.create!(author_id: 4, body: "hmm", chatable_type: "DirectMessage", chatable_id: dm_1.id)
    Message.create!(author_id: 4, body: "maybe ban kt", chatable_type: "DirectMessage", chatable_id: dm_1.id)

    dm_2 = DirectMessage.create!(speaker_id: 7, listener_id: user.id)
    Message.create!(author_id: 1, body: "This is the beginning of the direct message history between AndyEskimo and ShyGuy.", chatable_type: "DirectMessage", chatable_id: dm_2.id)
    Message.create!(author_id: 7, body: "is sabbsie anyone i know", chatable_type: "DirectMessage", chatable_id: dm_2.id)
    Message.create!(author_id: user.id, body: "ahh no", chatable_type: "DirectMessage", chatable_id: dm_2.id)
    Message.create!(author_id: user.id, body: "he probably played with us in OW though", chatable_type: "DirectMessage", chatable_id: dm_2.id)
    Message.create!(author_id: user.id, body: "he's bryan's friend's friend", chatable_type: "DirectMessage", chatable_id: dm_2.id)
    Message.create!(author_id: 7, body: "oic lol", chatable_type: "DirectMessage", chatable_id: dm_2.id)
    Message.create!(author_id: user.id, body: "and hes a smasher?", chatable_type: "DirectMessage", chatable_id: dm_2.id)
    Message.create!(author_id: user.id, body: "yeah apparently he streams too haha", chatable_type: "DirectMessage", chatable_id: dm_2.id)
    Message.create!(author_id: user.id, body: "must be pretty good", chatable_type: "DirectMessage", chatable_id: dm_2.id)
    Message.create!(author_id: 7, body: "o dayum", chatable_type: "DirectMessage", chatable_id: dm_2.id)
    Message.create!(author_id: 7, body: "cool", chatable_type: "DirectMessage", chatable_id: dm_2.id)

    dm_3 = DirectMessage.create!(speaker_id: 5, listener_id: user.id)
    Message.create!(author_id: 1, body: "This is the beginning of the direct message history between ShyGuy and smartglo1.", chatable_type: "DirectMessage", chatable_id: dm_3.id)
    Message.create!(author_id: user.id, body: "yo louis", chatable_type: "DirectMessage", chatable_id: dm_3.id)
    Message.create!(author_id: 5, body: "Yo", chatable_type: "DirectMessage", chatable_id: dm_3.id)
    Message.create!(author_id: 5, body: "Wassup", chatable_type: "DirectMessage", chatable_id: dm_3.id)
    Message.create!(author_id: user.id, body: "so I have logitech g35 headphones", chatable_type: "DirectMessage", chatable_id: dm_3.id)
    Message.create!(author_id: user.id, body: "and was wondering if you have the same problem with your headphones", chatable_type: "DirectMessage", chatable_id: dm_3.id)
    Message.create!(author_id: user.id, body: "where the audio for youtube is super quiet for some reason", chatable_type: "DirectMessage", chatable_id: dm_3.id)
    Message.create!(author_id: user.id, body: "i've looked it up and people have had the same issue for years", chatable_type: "DirectMessage", chatable_id: dm_3.id)
    Message.create!(author_id: user.id, body: "but I haven't found a fix for it", chatable_type: "DirectMessage", chatable_id: dm_3.id)
    Message.create!(author_id: 5, body: "i used to have the problem with my g930s", chatable_type: "DirectMessage", chatable_id: dm_3.id)
    Message.create!(author_id: 5, body: "and i just kinda switched to spekaers when i would watch youtube", chatable_type: "DirectMessage", chatable_id: dm_3.id)
    Message.create!(author_id: 5, body: "and then i stopped using them", chatable_type: "DirectMessage", chatable_id: dm_3.id)
    Message.create!(author_id: 5, body: "so i can't erally say there's a fix", chatable_type: "DirectMessage", chatable_id: dm_3.id)
    Message.create!(author_id: 5, body: "lol", chatable_type: "DirectMessage", chatable_id: dm_3.id)
    Message.create!(author_id: user.id, body: "damn haha", chatable_type: "DirectMessage", chatable_id: dm_3.id)
    Message.create!(author_id: user.id, body: "that's unfortunate", chatable_type: "DirectMessage", chatable_id: dm_3.id)
    Message.create!(author_id: user.id, body: "btw I kidna figured out how to fix the logitech headphone issue'", chatable_type: "DirectMessage", chatable_id: dm_3.id)
    Message.create!(author_id: user.id, body: "you have to click on the sound icon in the bottom right and click on mixer", chatable_type: "DirectMessage", chatable_id: dm_3.id)
    Message.create!(author_id: user.id, body: "and adjust it for chrome", chatable_type: "DirectMessage", chatable_id: dm_3.id)
    Message.create!(author_id: user.id, body: "have to do it every once in a while...", chatable_type: "DirectMessage", chatable_id: dm_3.id)
    Message.create!(author_id: 5, body: "I see", chatable_type: "DirectMessage", chatable_id: dm_3.id)
    Message.create!(author_id: 5, body: "Interesting", chatable_type: "DirectMessage", chatable_id: dm_3.id)

    dm_4 = DirectMessage.create!(speaker_id: 23, listener_id: user.id)
    Message.create!(author_id: 1, body: "This is the beginning of the direct message history between ShyGuy and rentaro.", chatable_type: "DirectMessage", chatable_id: dm_4.id)
    Message.create!(author_id: user.id, body: "yo ggs they were fun today", chatable_type: "DirectMessage", chatable_id: dm_4.id)
    Message.create!(author_id: 23, body: "yeah np gg", chatable_type: "DirectMessage", chatable_id: dm_4.id)
    Message.create!(author_id: user.id, body: "see you next week", chatable_type: "DirectMessage", chatable_id: dm_4.id)

    dm_5 = DirectMessage.create!(speaker_id: user.id, listener_id: 3)
    Message.create!(author_id: 1, body: "This is the beginning of the direct message history between ShyGuy and Sunny.", chatable_type: "DirectMessage", chatable_id: dm_5.id)
    Message.create!(author_id: user.id, body: "yo ben", chatable_type: "DirectMessage", chatable_id: dm_5.id)
    Message.create!(author_id: user.id, body: "with this tournament thing, would you want to cast with me?", chatable_type: "DirectMessage", chatable_id: dm_5.id)
    Message.create!(author_id: user.id, body: "i'm anticipating open bracket, rank 15 and below bracket, and rank 30 and below bracket", chatable_type: "DirectMessage", chatable_id: dm_5.id)
    Message.create!(author_id: user.id, body: "or maybe open, 10, 20, 30", chatable_type: "DirectMessage", chatable_id: dm_5.id)
    Message.create!(author_id: user.id, body: "but either way we can participate and cast as well", chatable_type: "DirectMessage", chatable_id: dm_5.id)
    Message.create!(author_id: user.id, body: "ben", chatable_type: "DirectMessage", chatable_id: dm_5.id)
    Message.create!(author_id: user.id, body: "game or no", chatable_type: "DirectMessage", chatable_id: dm_5.id)
    Message.create!(author_id: 3, body: "whats this", chatable_type: "DirectMessage", chatable_id: dm_5.id)
    Message.create!(author_id: 3, body: "join the server?", chatable_type: "DirectMessage", chatable_id: dm_5.id)
